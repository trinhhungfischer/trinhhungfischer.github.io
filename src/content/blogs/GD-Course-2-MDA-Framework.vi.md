...
*Lưu ý: 8 kiểu này chỉ là những ví dụ điển hình, nó không thể liệt kê hết tất cả những cảm xúc mà game có thể mang lại.*
...
![Canh chua cá lóc](/images/blogs/GD-Course-2/Untitled%201.png)
![Chè khúc bạch](/images/blogs/GD-Course-2/Untitled%202.png)
...
Ví dụ kinh điển như *Super Mario Bros* trên NES:
...
Ví dụ dòng game *Roguelike* từng được định nghĩa bởi rất nhiều luật lệ khắt khe ở hội nghị Berlin:
1. Dungeon random.
...
Bạn có thể loại bỏ hẳn một mechanic đặc trưng để tạo ra sự sáng tạo. Chẳng hạn, *VVVVVV* là game Platformer nhưng không hề có nút nhảy, thay vào đó là cơ chế đảo trọng lực! 
