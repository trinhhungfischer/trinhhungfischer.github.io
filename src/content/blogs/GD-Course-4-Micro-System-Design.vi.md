...
> _"People are motivated by how much is left to reach their target, not how far they’ve gone."_
> (Con người được thúc đẩy bởi khoảng cách còn lại để tới đích, chứ không phải quãng đường họ đã đi qua).

Trong nghiên cứu gốc, ông Hull viết: _"Rats in a maze run faster as they near the food box than at the beginning of the path"_ (Chuột trong mê cung chạy nhanh hơn khi chúng tới gần hộp thức ăn so với lúc mới bắt đầu).
...
- _Ưu điểm_: Dễ thiết kế vì biết trước lượng tối đa.
- _Nhược điểm_: Dễ vỡ hệ thống khi phát sinh yêu cầu mới (muốn tăng/giảm giới hạn).
...
- _Ưu điểm_: Đơn giản, dễ tính, tạo sự kỳ vọng chuẩn xác.
- _Nhược điểm_: Đơn điệu, dễ đoán, khó tạo cảm xúc bùng nổ theo giai đoạn.
...
- _Thường sử dụng ở đầu game_: Nhằm tạo cảm giác tiến bộ thần tốc, lôi cuốn người chơi mới.
- _Áp dụng_: Dùng để cân bằng giữa thời gian đầu tư và lợi ích, kiềm chế "người cày trâu" (vì càng về sau cày càng chua).
...
Đây là một loại nguồn thoát _thích nghi_, không thể mô tả qua hàm số cố định. Lượng tài nguyên bạn "đốt" đi phụ thuộc vào đối thủ của bạn là ai. Thường áp dụng rất mạnh trong các chế độ PvP (Như _Clash Of Clan_).
...
_Một quy tắc xương máu của thiết kế hệ thống là: Luôn balance giữa tài nguyên thực (thời gian, tiền ngoài đời) và tài nguyên ảo trong Game!_
...
- Hiệu ứng tiệm cận mục tiêu: **Goal Gradient Effect** (Clark Hull, 1932).
